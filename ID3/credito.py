...
atributo_clasificación='Crédito'
clases=['conceder','no conceder','estudiar']


entr=[['jubilado','ninguno','ninguna','uno','soltero','altos','estudiar'],
...
valid=[['parado','uno','ninguna','ninguno','casado','bajos','no conceder'],
...
test=[['funcionario','ninguno','dos o más','ninguno','divorciado','medios','conceder'],
